...
<head>
    ...
    *************************************-->
    ...
    <link rel="stylesheet" href="{{url('front/plugins/css/fontawesome.min.css')}}">
    <link rel="stylesheet" href="{{url('front/css/ionicons.min.css')}}" />
    <link rel="stylesheet" href="{{url('front/css/simple-line-icons.css')}}" />
    <link rel="stylesheet" href="{{url('front/css/plugins/jquery-ui.min.css')}}">
    <link rel="stylesheet" href="{{url('front/css/bootstrap.min.css')}}" />
    <link rel="stylesheet" href="{{url('front/css/plugins/plugins.css')}}" />
...
<style type="text/css">
    .topheader{
        background-image: linear-gradient(to right, #BFB2F3,#F8A3A8);
    }
    .sr_btn{
...
<header>
    <!-- header top start -->
    <div class="header-top theme1 topheader py-15">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-7 order-last order-md-first">
                    <div class="static-info text-center text-md-left">
                        <p class="text-white">“Trendy is the last stage before tacky.” – Karl Lagerfeld <span class="theme-color">Be Trendy</span> !
                           </p>
                    </div>
                </div>
                    ...
                    <nav class="navbar-top pb-2 pb-md-0 position-relative">
                        <ul class="d-flex justify-content-center justify-content-md-end align-items-center">
                          ...
                          @if(Auth::check())
                            ...
                            <li><a href="{{url('myaccount')}}">{{ Auth::user()->name }}<li></a>
            ...
            <div class="row align-items-center">
                <div class="col-sm-6 col-lg-2 order-first">
                    <div class="logo text-center text-sm-left mb-30 mb-sm-0">
                        <a href="index.html"><img src="{{url('front/img/logo/filoo.jpeg')}}" alt="logo"></a>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-5 col-xl-4">
                    ...
                    <div class="d-flex align-items-center justify-content-center justify-content-sm-end">
                        <div class="media static-media mr-50 d-none d-lg-flex">
                            <!-- <img class="mr-3 align-self-center" src="{{url('front/img/icon/1.png')}}" alt="icon"> -->
                ...
                <div class="col-lg-5 col-xl-6 order-lg-first">
                    <div class="search-form pt-30 pt-lg-0">
                        <form class="form-inline position-relative">
                            ...
                            <button class="btn search-btn sr_btn btn-rounded" type="submit"><i
                ...
                <div class="col-lg-10 offset-lg-2 d-flex flex-wrap align-items-center position-relative">
                    <ul class="main-menu d-flex">
                        <li class="active ml-0">
                            <a href="{{url('front/index')}}" class="pl-0">Home</a>
                       ...
                       <li>
                            <a href="{{url('contact')}}">Contact Us <i class="ion-ios-arrow-down"></i></a>
                    </ul>
...
<!-- footer strat -->
<footer class="topheader theme1 position-relative">
    <!-- footer bottom start -->
                ...
                <div class="col-12 col-md-6 col-lg-4 mb-30">
                    <div class="footer-widget mx-w-400">
                        <div class="footer-logo mb-35">
                            <a href="index.html">
                                <img src="{{url('front/img/logo/foim.png')}}" alt="footer logo">
                            </a>
                        </div>
                        ...
                        <div class="address-widget mb-30">
                            <div class="media">
                                <!-- <span class="address-icon mr-3">
                                    <img src="{{url('front/img/icon/phone.png')}}" alt="phone">
                                </span>
                                <div class="media-body">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="text-left">
                        <p class="mb-3 mb-md-0">Copyright &copy; <a href="https://hasthemes.com/">DivyaJain</a>. All
                            Rights Reserved</p>
                    </div>
                </div>
...
<!-- modals end -->
    ...
    <script src="{{url('front/js/vendor/jquery-3.5.1.min.js')}}"></script>
    <script src="{{url('front/js/vendor/modernizr-3.7.1.min.js')}}"></script>
    <script src="{{url('front/js/popper.min.js')}}"></script>
    <script src="{{url('front/js/plugins/jquery-ui.min.js')}}"></script>
