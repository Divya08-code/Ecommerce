        ...
        <div class="row">
            <div class="col-lg-6 mb-5 mb-lg-0">
                ...
                <div class="product-sync-nav single-product">
                    <div class="single-product">
                        <div class="product-thumb">
                            <a href="javascript:void(0)"> <img src="{{url('/upload/'.$product->product_image)}}"
                                    alt="product-thumb"></a>
                        </div>
                    </div>
                    <!-- single-product end -->
                                ...
                                <div class="media flex-column">
                                    <div class="product-thumbnail position-relative">
                                        ...
                                        <a href="single-product.html">
                                            <img class="first-img" src="{{url('front/img/new-products/1.jpg')}}" alt="thumbnail">
                                            <img class="second-img" src="{{url('front/img/new-products/1.1.jpg')}}"
                                                alt="thumbnail">
                                        </a>
                                        <!-- product links -->
                            ...
                            <div class="card-body p-0">
                                <div class="media flex-column">
                                    <div class="product-thumbnail position-relative">
                                        <span class="badge badge-danger top-right">New</span>
                                        <a href="single-product.html">
                                            <img class="first-img" src="{{url('front/img/new-products/2.jpg')}}" alt="thumbnail">
                                        </a>
                                        <!-- product links -->
                                        <ul class="product-links d-flex justify-content-center">
                                            <li>
                            ...
                            <div class="card-body p-0">
                                <div class="media flex-column">
                                    <div class="product-thumbnail position-relative">
                                        ...
                                        <span class="badge badge-danger top-right">New</span>
                                        <a href="single-product.html">
                                            <img class="first-img" src="{{url('front/img/new-products/3.jpg')}}" alt="thumbnail">
                                        </a>
                                        <!-- product links -->
                                        <ul class="product-links d-flex justify-content-center">
                                            <li>
                            ...
                            <div class="card-body p-0">
                                <div class="media flex-column">
                                    <div class="product-thumbnail position-relative">
                                        <span class="badge badge-danger top-right">New</span>
                                        <a href="single-product.html">
                                            <img class="first-img" src="{{url('front/img/new-products/4.jpg')}}" alt="thumbnail">
                                            <img class="second-img" src="{{url('front/img/new-products/4.1.jpg')}}"
                                                alt="thumbnail">
                                        </a>
                                        <!-- product links -->
                                        <ul class="product-links d-flex justify-content-center">
                            ...
                            <div class="card-body p-0">
                                <div class="media flex-column">
                                    <div class="product-thumbnail position-relative">
                                        <span class="badge badge-danger top-right">New</span>
                                        <a href="single-product.html">
                                            <img class="first-img" src="{{url('front/img/new-products/5.jpg')}}" alt="thumbnail">
                                        </a>
                                        <!-- product links -->
                                        <ul class="product-links d-flex justify-content-center">
                                            <li>
                            ...
                            <div class="card-body p-0">
                                <div class="media flex-column">
                                    <div class="product-thumbnail position-relative">
                                        <span class="badge badge-danger top-right">New</span>
                                        <a href="single-product.html">
                                            <img class="first-img" src="{{url('front/img/new-products/6.jpg')}}" alt="thumbnail">
                                        </a>
                                        <!-- product links -->
                                        <ul class="product-links d-flex justify-content-center">
                                            <li>
